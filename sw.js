...
/* ── v212 — PREMIÈRES CARTES DE FRANÇAIS-PHILOSOPHIE (thème « Les arcanes de la création »).
   54 cartes sur les trois œuvres et le thème : Platon (Ion 5, République X 9), Zola (14), Woolf (12),
   le thème et ses notions (10), citations réutilisables (4).
   Conçues pour être APPRISES PAR CŒUR : une carte = un fait, réponse d'une à trois lignes
   (médiane 172 signes, aucune au-delà de 223), référence systématique — numérotation Stephanus pour
   Platon (533d pour la pierre d'Héraclée, 597e pour les trois degrés, 607a pour l'exclusion des poètes),
   chapitre ou date pour Zola et Woolf.
   Règle appliquée à la rédaction : au moindre doute sur un fait ou sur le libellé exact d'une citation
   dans la traduction prescrite, la carte est écartée ou l'idée reformulée sans guillemets — une citation
   fausse serait récitée telle quelle à l'épreuve. Toutes les cartes ont été relues par un correcteur
   distinct de leur rédacteur.
   DEUX CARTES ONT ÉTÉ CORRIGÉES APRÈS VÉRIFICATION INDÉPENDANTE :
   • la brouille de Zola et Cézanne après L'Œuvre, présentée partout comme un fait, est CONTESTÉE :
     une lettre de Cézanne du 28 novembre 1887, retrouvée en 2013, remercie Zola pour La Terre et
     propose de venir le voir. La carte le dit désormais, ce qui en fait une nuance utile en dissertation ;
     • une mention non vérifiable du rôle de Fagerolles au jury a été retirée.
   Les deux sections de méthode (résumé, dissertation) restent volontairement vides. */
/* ── v213 — LES CITATIONS SONT DÉSORMAIS LOCALISABLES, ET LE PÉRIMÈTRE DU PROGRAMME EST GARANTI.
   Demande élève : ne rien apprendre qui sorte des œuvres au programme (risque de sanction), et
   pouvoir retrouver chaque passage dans l'édition prescrite.
   • PÉRIMÈTRE VÉRIFIÉ. Les 32 références Stephanus des cartes de Platon ont été contrôlées contre les
     bornes du programme : La République est limitée à 595a-608b — une citation en 614a (mythe d'Er)
     serait hors sujet — et Ion à 530a-542b. Aucune ne sort de ces bornes.
   • RÉFÉRENCEMENT AJOUTÉ à 28 cartes, sous la forme « Où le trouver : … ». Le système retenu vaut dans
     N'IMPORTE QUELLE édition : numérotation Stephanus pour Platon (elle figure en marge de toutes les
     éditions), numéro de CHAPITRE pour Zola (I à XII) et Woolf (1 à 6). Aucun numéro de page : il
     changerait d'une édition à l'autre.
     Les cartes purement bibliographiques (année de parution, rang dans les Rougon-Macquart, origine
     des conférences de Woolf) n'en reçoivent pas : il n'y a pas de passage à retrouver.
   • UNE CARTE SIGNALÉE HORS PROGRAMME. La filiation de Claude Lantier — fils de Gervaise, frère
     d'Étienne et de Jacques — ne vient PAS de L'Œuvre mais du cycle des Rougon-Macquart
     (L'Assommoir, Germinal, La Bête humaine). La carte le dit maintenant explicitement : à savoir,
     mais à ne pas présenter au correcteur comme une donnée du texte étudié. C'est exactement le type
     de confusion qui coûte des points.
   Réserve maintenue : ces références sont des repères de structure, fiables par construction. Le
   libellé exact d'une citation entre guillemets (il n'en reste que 9 sur 54 cartes) reste à vérifier
   dans la traduction prescrite — Canto-Sperber, Leroux, Darrieussecq. */
/* ── v214 — WOOLF : LA TRADUCTION DARRIEUSSECQ EST CELLE DU PROGRAMME, ET RIEN D'AUTRE.
   Le piège est réel : la traduction classique de Clara Malraux donne « Une chambre à soi », celle de
   Marie Darrieussecq — la seule au programme — donne « Un lieu à soi ». Citer la première serait
   sanctionné, et les deux traductions ne disent pas les mêmes mots.
   • CONTRÔLE : aucune carte n'employait le vocabulaire de la traduction Malraux ; le titre au
     programme est respecté partout. Le seul endroit où « Une chambre à soi » apparaît désormais est
     l'AVERTISSEMENT qui dit précisément de ne pas la citer.
   • DEUX QUESTIONS REFORMULÉES pour ne pas figer un libellé invérifiable : « la phrase héritée » et
     « Chloé aimait Olivia » étaient données entre guillemets alors que rien ne garantissait que ce
     soit le texte exact de Darrieussecq (l'anglais dit « the man's sentence » et « Chloe liked
     Olivia »). Les cartes portent maintenant sur l'IDÉE, avec le chapitre pour la retrouver ;
     l'élève relèvera le libellé dans son édition.
   • Une carte Woolf porte la mention de la traduction au programme et la consigne de relevé.
   Il ne reste que 8 citations entre guillemets sur 54 cartes, toutes courtes : chez Platon des termes
   conceptuels stables d'une traduction à l'autre (« enthousiasme », « ancienne querelle »), chez Zola
   deux formules vérifiées sur le texte intégral, qui est dans le domaine public (chapitres IX et XII). */
/* ── v215 — LES CITATIONS ONT LEUR PROPRE SECTION, ET ELLE EN CONTIENT VRAIMENT.
   Constat en auditant : la section « 9. Citations et références du thème » ne contenait AUCUNE
   citation — seulement des cartes de synthèse et de rapprochement entre œuvres. Réorganisation :
   • les 3 cartes de rapprochement et de synthèse rejoignent « 6. Notions et problématiques » ;
   • la section « Citations » accueille les cartes dont la RÉPONSE est une citation à réciter ;
   • 6 CITATIONS DE ZOLA ajoutées, chacune avec son chapitre et ce qu'elle sert à démontrer :
     le projet de Sandoz (VI), la peinture rivale de Christine (IX), la pendaison devant l'œuvre
     manquée (XII), « une impuissance fatale » (IX), le retour de la stérilité (IX), la dernière
     toile (XII).
   POURQUOI ZOLA SEULEMENT : le roman est dans le domaine public, son texte est donc vérifiable mot à
   mot — ces six citations ont été confrontées à l'édition intégrale. Les traductions de Platon
   (Canto-Sperber, Leroux) et de Woolf (Darrieussecq) sont, elles, protégées et je ne les ai pas sous
   les yeux : aucune citation n'en est tirée. Contrôle automatique : 0 citation issue d'une traduction.
   Les déplacements ne touchent que le champ topic, jamais l'énoncé : le hash des cartes est inchangé,
   la progression acquise dessus est préservée.
   Français-philosophie : 60 cartes au total. */
/* ── v216 — ÉTYMOLOGIE D'« ARCANE » : formulation clarifiée après une question de l'élève.
   La carte disait vrai — le français vient bien de arcanum, neutre substantivé de arcanus — mais
   l'élève a buté sur la coexistence des deux formes, ce qu'un correcteur pourrait faire aussi.
   Vérification faite au CNRTL, qui donne « empr. au lat. arcanum, plur. arcana ». La réponse
   distingue désormais explicitement les deux niveaux : l'ADJECTIF est arcanus, -a, -um (« caché ») ;
   le NOM qui a donné le français est arcanum (« le secret »), son neutre substantivé — c'est lui
   l'étymon direct. Le rattachement de arca à arcere (« écarter, contenir ») est conservé en
   explication : l'image première est le coffre fermé, d'où le secret réservé aux initiés.
   La QUESTION n'a pas été touchée : le hash de la carte est identique, la progression est préservée. */
/* ── v217 — FRANÇAIS : 72 CARTES D'APPROFONDISSEMENT (132 au total sur le thème).
   Produites à partir des deux ressources fournies par l'élève — un cours de prépa de 39 pages et une
   synthèse en ligne — complétées par des recherches, puis relues par un correcteur distinct.
   Le niveau visé n'est plus le repérage mais ce qui départage une copie : distinctions conceptuelles
   (poïésis/praxis chez Aristote, inspiration/imagination, création/créativité, invention comme
   « trouver » et non « produire du néant »), CONTRESENS À ÉVITER explicitement signalés (l'arcane
   n'est pas le mystère vague mais un secret de fabrication transmissible ; la technè n'est pas la
   technique moderne ; l'enthousiasme antique est une dépossession, non un élan), structure
   argumentative des textes, et confrontations précises entre œuvres.
   GARDE-FOUS APPLIQUÉS AVANT INJECTION :
   • Doublon d'étymologie détecté et résolu : une nouvelle carte donnait « arcanus » là où le CNRTL
     donne « arcanum » — elle est recentrée sur le SENS du mot, l'étymologie restant traitée par la
     carte corrigée en v216. Deux cartes ne se contredisent plus.
   • 5 cartes marquées « référence de culture, hors programme » : Timée, Kant, Aristote, Horace,
     Reckwitz sont des appuis légitimes en dissertation, jamais des textes au programme. La distinction
     est écrite sur la carte pour éviter la confusion devant un correcteur.
   • Aucune citation issue d'une traduction protégée : contrôle automatique sur toutes les cartes de
     Platon et de Woolf. Le sujet de la conférence de Woolf est donné sous son titre anglais,
     « Women and Fiction », dont la traduction française varie.
   • Aucune collision de hash avec les 60 cartes déjà en ligne. */
/* ── v218 — « <i> » S'AFFICHAIT EN TOUTES LETTRES DANS LES ÉNONCÉS DE FRANÇAIS. Signalement élève.
   Cause : les énoncés passent par qHTML, qui échappe TOUT « < » suivi d'une lettre. Cette protection
   est indispensable en sciences — sans elle, « $p<m\le n$ » fait disparaître la fin de l'énoncé,
   le navigateur y voyant le début d'une balise (défaut corrigé en v190). Mais les cartes de français
   emploient une mise en forme légitime dans la QUESTION : titres d'œuvres en italique, termes en gras.
   Résultat : 36 énoncés affichaient « &lt;i>L'Œuvre</i> » au lieu du titre en italique.
   Correction : qHTML met de côté les balises d'une LISTE BLANCHE (b, i, em, strong, sup, sub) avant
   d'échapper, puis les rétablit. Les balises légitimes passent, tout le reste continue d'être neutralisé
   — y compris une balise dangereuse, vérifié.
   Les ÉNONCÉS NE SONT PAS MODIFIÉS : la correction est à l'affichage seulement, donc les hash — et
   la progression acquise sur ces 36 cartes — sont intacts.
   Vérifié sur les cartes réelles : 36 énoncés à balises, 0 encore cassé, et la protection contre les
   « < » bruts reste active. */
/* ── v219 — CARTES DE MÉTHODE RÉÉCRITES EN LANGAGE CLAIR. Signalement élève : « je ne comprends
   rien à cette carte ». Le reproche était fondé : la carte empilait trois idées denses dans un
   vocabulaire de professeur (« mobiliser une œuvre », « lui faire porter un argument »), là où une
   carte de méthode doit être immédiatement actionnable.
   Trois cartes de « Méthode : la dissertation » reprises :
   • « Comment mobiliser L'Œuvre sans paraphraser l'intrigue ? » devient « En dissertation, comment
     utiliser un exemple tiré de L'Œuvre sans raconter le roman ? », avec une consigne en trois gestes
     — choisis un seul moment, situe-le, dis ce qu'il prouve — puis l'exemple.
   • « Quel plan est disqualifiant ? » devient « Quel plan faut-il éviter absolument, et par quoi le
     remplacer ? ».
   • « Comment problématiser sans retomber sur… » devient « Pourquoi le couple inspiration contre
     travail ne suffit-il pas à problématiser ? ».
   Principe retenu pour toute carte de méthode : dire ce qu'il faut FAIRE, dans les mots de l'élève,
   avec un exemple concret — pas énoncer un principe abstrait. Un balayage du reste des cartes de
   notions et de méthode n'a pas trouvé d'autre formulation jargonnante. */
/* ── v220 — LE KIT « ARCANES DE LA CRÉATION » EST FICHÉ, CITATIONS COMPRISES.
   37 cartes tirées du kit fourni par l'élève (7 encadrés de notions, 24 citations analysées,
   10 blocs prérédigés), dont 19 portent une citation.
   CORRECTION D'UNE ERREUR DE MA PART : j'avais d'abord écarté les citations de Platon et de Woolf en
   invoquant le droit d'auteur. C'était faux — l'exception de courte citation à but pédagogique
   (CPI L122-5) les autorise expressément, et une dissertation de français sans citations n'existe pas.
   Les citations sont donc reprises, courtes et référencées.
   Ce qui subsiste ne relève pas du droit mais de la FIABILITÉ :
   • aucune référence par numéro de page — le kit en donne, mais elles ne valent que pour son édition
     et son auteur les signale faillibles ; converties en Stephanus (Platon) ou en chapitre (Zola, Woolf) ;
   • mention « Vérifie le libellé exact dans ton édition » sur toute carte citant Platon ou Woolf,
     dont je n'ai pas les traductions sous les yeux. Zola, du domaine public et vérifiable, en est dispensé ;
   • les ANALYSES de l'enseignant et ses blocs prérédigés sont reformulés, jamais recopiés : une carte
     doit faire retrouver quel exemple prouve quelle idée, pas faire réciter un paragraphe tout fait.
   Français-philosophie : 169 cartes. Deux sections du kit (République X, blocs) ont calé et sont en
   cours de reprise. */
/* ── v221 — LE KIT EST ENTIÈREMENT FICHÉ : 62 cartes de plus.
   Les deux sections qui avaient calé (La République X et les 10 blocs prérédigés) ont été reprises.
   Le rejeu ayant relancé toutes les sections, il produisait 100 cartes dont beaucoup répétaient les
   37 déjà injectées : DÉDOUBLONNAGE en deux passes — hash identique, puis similarité des mots
   significatifs de la question (seuil 0,55). 38 cartes écartées, 62 réellement nouvelles retenues,
   dont 8 sur La République X et 15 de méthode de dissertation.
   Contrôles passés : format, chapitres existants, et surtout BORNES DU PROGRAMME — toute référence
   Stephanus doit tomber dans 530a-542b (Ion) ou 595a-608b (République X). Aucune n'en sort.
   Réponses d'une à trois lignes (médiane 141 signes, maximum 246).
   Français-philosophie : 231 cartes. L'application en compte 2 229.
   Reste vide, volontairement : « 7. Méthode : le résumé de texte ». */
/* ── v222 — TRI EXHAUSTIF DES CARTES DE FRANÇAIS : 231 -> 107. Le jeu avait enflé au point de ne
   plus être révisable. Chaque carte a été jugée (231 verdicts, aucune oubliée) par un premier
   correcteur, puis contrôlée par un arbitre chargé de rattraper les pertes inacceptables.
   Critères, par ordre : utilité réelle en dissertation ; absence de redondance ; mémorisabilité ;
   non-trivialité ; exactitude. La redondance a fourni l'essentiel des coupes — quatre cartes
   portaient sur la dernière phrase du roman de Zola, trois sur « Chloe aimait Olivia ».
   Protégés du tri : les citations référencées, les définitions des notions du programme, les
   contresens à éviter, les confrontations entre œuvres, et au moins une carte de cadrage par œuvre.
   Résultat équilibré, aucune section vidée : thème 5, Ion 10, République X 12, Zola 12, Woolf 18,
   notions 16, dissertation 10, citations 24. Les citations passent de 82 à 43 : on garde la meilleure
   formulation de chaque idée, pas toutes ses variantes.
   Une ERREUR FACTUELLE a été trouvée au passage et écartée : une carte situait la mort de Claude
   Lantier au chapitre XI alors qu'elle est au XII.
   Les 124 cartes retirées sont conservées hors ligne avec le motif de leur mise à l'écart.
   Français : 107 cartes. Application : 2 105. */
/* v223 — CONFORMITE AU PROGRAMME OFFICIEL TSI1 (arrete du 9 juillet 2021, BO n30 du 29/07/2021). Audit exhaustif : les 1998 cartes scientifiques confrontees une a une au texte officiel (source retelechargee, 493 pages ; le programme 2013 en cache est ABROGE et a ete ecarte). 14 cartes portaient sur des notions que le programme EXCLUT nommement. Corrigees SANS toucher a un seul enonce : le qHash porte sur q, donc AUCUNE progression SRS n'est perdue ; seuls answer/exp changent. (1) DISTANCES point-droite et point-plan, 4 cartes : le programme dit « Aucune formule de distance d'un point a une droite ou a un plan n'est au programme » et demande le PROJETE ORTHOGONAL. Les cartes enseignaient la formule ; elles renvoient desormais a la methode exigible. Deux d'entre elles passent de mode saisie a mode flash, la reponse n'etant plus une formule a taper. La carte #1346 du meme chapitre appliquait deja la bonne methode : les cartes la contredisaient. (2) cos(arcsin x) et sin(arccos x), 2 cartes : « Les formules du type sin(arccos x) ne sont pas a connaitre » — le programme cite litteralement l'une des deux. Reponse conservee mais presentee comme a RETROUVER (identite de Pythagore puis signe donne par l'intervalle), non a memoriser. (3) THEOREME DE LA LIMITE DE LA DERIVEE : « Le theoreme de la limite de la derivee est hors programme ». La carte le faisait apprendre alors qu'une autre carte du fichier le declarait exclu — les deux se contredisaient. Aligne sur le traitement deja en place (on garde la question, la reponse signale l'exclusion et renvoie au taux d'accroissement). (4) NOTATION A_n^p, 5 cartes : « La notation A_n^p est hors programme ». Le nombre d'arrangements reste au programme : seule la notation part, remplacee par le quotient de factorielles. (5) RECURRENCE FORTE : « Dans la pratique, on se limite aux recurrences simple ou double ». (6) RAILS DE LAPLACE : « Toute etude du champ electromoteur est exclue » — l'explication developpait v^B, elle impose desormais la redaction par le flux puis Faraday. NON TOUCHE, sur decision de l'eleve : le contenu de SECONDE ANNEE loge dans des chapitres TSI1 (determinant, trace, Cramer, projecteurs, symetries en maths ; hacheurs, bilan de puissance MCC et AOP/ALI en SI) — c'est le programme revise cette annee. Rien n'y est hors programme. VERIFS : 2105 cartes avant et apres, aucun enonce modifie (controle automatique), module ES compile, aucune redeclaration, aucune virgule double. Sauvegarde locale : index.html.avant_hp. */
/* v227 — TABLEAU DE BORD : les compteurs disaient mal l'effort fourni. (1) FAMILLES SOLIDES etait un palier INATTEIGNABLE, bloque a 0 : la regle moyennait un score sur TOUTES les cartes de la famille, les cartes jamais vues comptant 0,15 — sur une banque de 2 105 cartes la moyenne ne pouvait pas franchir le seuil de 0,7. On mesure desormais le travail reellement fait : parmi les cartes DEJA VUES d'une famille, la part solidement installee (intervalle >= 7 j), des 8 cartes vues et 70 % installees. Le compteur affiche aussi son denominateur (« sur N familles entamees »). (2) PALIERS RECALIBRES sur une annee de prepa : « cartes maitrisees » passait de 10 a 100 et « reponses » de 50 a 1 000 — deux jauges deja saturees en « Palier max atteint », donc muettes le reste de l'annee. Nouveaux seuils 50/150/400/800 et 200/1 000/3 000/6 000. (3) INDICES sous chaque palier : ce que mesure le chiffre et ce qui reste a faire (« 210 autres en cours de consolidation », « 364 cartes maitrisees sur 2 105 »). (4) COLLES ET ORAUX BLANCS, absents du tableau de bord alors qu'ils produisent la donnee la plus parlante du site : deux paliers apparaissent des la premiere epreuve passee, et une section « Epreuves blanches » donne moyenne, record, et surtout la PROGRESSION (moyenne des 3 dernieres contre les 3 precedentes) — le signal que l'effort paie. Rien ne s'affiche tant qu'aucune epreuve n'a ete passee. (5) CARTE D'ACTIVITE : libelles de mois au-dessus de la grille (elle etait illisible sans reperes), pied de grille avec jours actifs, volume total et RECORD de jours d'affilee, legende moins/plus, et mention « objectif tenu N semaines d'affilee ». L'objectif hebdo n'affiche plus de fraction impossible du type « 6/5 jours actifs ». (6) MOBILE : les paliers passaient en UNE colonne (minmax 148px) — huit cartes empilees ; seuil abaisse a 138px, deux colonnes des 375 px. VERIFS EN NAVIGATEUR sur donnees simulees (734 cartes, 1 801 revisions, 64 sessions, 9 colles, 4 oraux) : 18 etiquettes de mois pour 18 colonnes alignees au pixel, 8 paliers de hauteur identique, aucun debordement horizontal en 1200px ni en 375px, bloc epreuves correctement masque quand le journal est vide (paliers 8 -> 6), lien vers l'historique fonctionnel sans erreur console. */
/* v228 — DEUX DEFAUTS SIGNALES PAR L'ELEVE, tous deux confirmes sur le code. (A) « J'AI FAIT BIEN PLUS QUE 81 CARTES HIER » : le compte d'activite etait faux, par TROIS erreurs cumulees. 1) agg.dayset ne porte qu'un DRAPEAU de presence (=1 par jour actif) et la grille le traitait comme un volume, puis ajoutait les totaux de sessions par-dessus : +1 parasite sur chaque jour. 2) Seules les 20 dernieres sessions sont lues du cloud ; au-dela, tout jour actif retombait a « 1 carte », quel que soit le travail fourni — c'est l'origine du chiffre trop bas. 3) Le journal local reviewLog, seul enregistrement exact (une entree par carte notee), etait IGNORE des qu'on est connecte ; et hors connexion il etait ADDITIONNE aux totaux de sessions, alors que toute reponse de session y figure deja : chaque reponse comptait donc deux fois. Correctif : on retient le MAXIMUM des sources chiffrees au lieu de leur somme, le drapeau ne servant qu'a marquer un jour actif dont le volume n'est plus connu (infobulle explicite, et le pied de grille distingue ce qui est mesure). Mesure sur jeu d'essai : 3 843 -> 3 000, valeur recalculee independamment. Les seuils de couleur (3/8/15), calibres sur des comptes faux, saturaient des la premiere vraie journee : passes a 10/25/50. Infobulles « N cartes revisees » au lieu de « N actions ». (B) « J'AI CLIQUE SUR FR-PHILO ET LE MENU AVEC LES GRAPHES A DISPARU » : le radar exige 3 sommets, or TOUT le bloc — SELECTEUR DE MATIERE COMPRIS — etait conditionne a ce seuil. Le francais-philosophie n'ayant que 2 familles, choisir cette matiere effacait la section entiere ET le moyen d'en sortir : l'eleve etait piege jusqu'au rechargement. Le titre et le selecteur sont desormais toujours rendus ; une matiere a moins de 3 familles recoit des barres horizontales, et une matiere sans carte travaillee un message clair. A SAVOIR, non corrige ici : le MODE EXAMEN n'enregistre ni session ni revision — ses reponses n'apparaissent dans aucun compteur. Verifie en navigateur : total recalcule a la main = affichage, selecteur conserve sur les 4 matieres et retour aux maths possible, 5 nuances de palette effectivement utilisees, aucun debordement. */
/* v229 — CITATIONS DE FRANCAIS : verification integrale apres un signalement de l'eleve, qui avait repere une citation de l'Ion issue d'une AUTRE edition que celle au programme. Deux regimes, opposes. (1) ZOLA, L'Oeuvre : texte original francais, domaine public, donc VERIFIABLE. Roman telecharge en entier depuis Wikisource (12 chapitres, 800 000 caracteres) et les 14 citations confrontees mot pour mot : les 14 sont EXACTES. Mais deux erreurs de CONTEXTE ont ete trouvees. « Tout finissait et rien ne recommencait » etait donne au chapitre XII : c'est le XI, et surtout c'est Sandoz pleurant sa vie passee, non un jugement sur la toile de Claude — la carte en faisait un contresens ; remplacee par deux formules verifiees du meme chapitre (« une application entetee et sans espoir », « l'oeuvre manquee de sa vie »), avec une mise en garde explicite. « Ce monsieur, tout habille, la, au milieu de ces femmes nues... » etait attribue a la foule du Salon des Refuses : c'est Dubuche, dans l'atelier, au chapitre II ; la foule ne rira qu'au chapitre V. (2) PLATON (Ion, trad. Canto-Sperber ; Republique X, trad. Leroux) et WOOLF (Un lieu a soi, trad. Darrieussecq) : ce sont des TRADUCTIONS sous droits, que je n'ai pas lues. Le mot a mot y change d'une traduction a l'autre et AUCUNE de ces citations n'etait verifiable. Elles sont donc toutes retirees des guillemets et remplacees par l'idee exacte + la reference (numerotation Stephanus pour Platon, chapitre pour Woolf), qui valent dans toutes les editions. Indice le plus net : une carte faisait apprendre « de l'argent et une piece a soi », qui ne correspond ni au titre au programme (« Un lieu a soi », Darrieussecq, Denoel 2016) ni a l'ancienne traduction (« Une chambre a soi », Clara Malraux) — c'etait une formulation sans source. L'avertissement generique « Verifie le libelle exact dans ton edition » (28 cartes), trop faible, devient « Ne cite jamais ces mots de memoire » avec le nom du traducteur attendu. 23 cartes reprises, uniquement dans answer/exp : AUCUN enonce touche, donc aucune progression perdue (verifie automatiquement, 2103 enonces identiques avant et apres). */
/* v230 — RENTREE TSI2 : le perimetre d'annee s'applique enfin a la REVISION. DEFAUT DE FOND : le selecteur TSI1/TSI2 ne pilotait que le quiz personnalise (poolFilter). La revision quotidienne, elle, piochait dans QUESTIONS EN ENTIER — SRS.due() renvoie toutes les cartes dues sans distinction d'annee, et makeReviewSource ne filtrait rien. Un eleve de TSI2 ayant choisi TSI2 recevait donc quand meme des cartes de TSI1, et le compteur « a reviser » comptait du hors-classe. CORRECTIF : nouveau perimetre (revLevel / reviewScopeOk / dueScoped) applique aux cartes dues, aux nouvelles cartes ET au reservoir d'entrainement libre, ainsi qu'aux deux compteurs affiches, pour qu'ils annoncent exactement ce qui sera servi. Les matieres TRANSVERSALES (francais, anglais) valent pour les deux annees et ne sont jamais masquees. BOUTON « Reviser les deux annees », reserve aux eleves dont la classe autorise plus d'une annee (un TSI1 n'a pas a recevoir du TSI2 qu'il n'a pas vu) ; preference persistee. GARDE-FOU : quand le perimetre met des cartes dues de cote, on l'AFFICHE (« N cartes dues dans l'autre annee, masquees par ce choix ») au lieu de les faire disparaitre en silence — sans quoi le retard de TSI1 s'accumulerait sans que l'eleve le sache. AU PASSAGE : changer d'annee ne rafraichissait ni l'en-tete ni la barre SRS, qui gardaient les chiffres de l'annee precedente. ESSENTIELS : le code prevoyait niveau:'approfondissement' et le filtre etait deja cable partout, mais AUCUNE carte ne portait ce champ — le selecteur « Inclure l'approfondissement » ne filtrait donc rien depuis toujours. 49 cartes d'application sont desormais marquees. Un premier jet en avait marque 89, mais la relecture a montre de vrais faux positifs — « sin(2a) », « cos(2x) », « combien de solutions ? » sont des resultats GENERAUX que le critere prenait pour des applications, et les masquer aurait retire des cartes de cours des essentiels. Le critere a ete resserre aux seules regles a haute precision : coordonnees entierement chiffrees, donnee nommee en capitales, series systematiques de SI, reconnaissance sur un cas fourni, valeur trigonometrique dont l'argument ne contient aucune lettre, matrice entierement numerique. Les 13 cartes marquees hors SI ont ete relues une a une. Aucun chapitre ne perd la totalite de ses essentiels. Ajout d'un champ aux cartes : aucun enonce touche, progression SRS intacte (2103 enonces identiques). VERIFIE EN NAVIGATEUR sur donnees simulees : TSI1 seul 120 a reviser (+328), TSI2 seul 0 avec l'avertissement « 448 cartes dues dans l'autre annee », les deux annees 120 (+328), bascule dans les deux sens. NOTE : les 39 chapitres de TSI2 sont encore vides, choisir TSI2 ne propose donc rien pour l'instant (comportement voulu, badge « bientot »). */
/* v230 — MOT DU JURY : 10 nouvelles entrées (Physique-Chimie, Sciences de l'Ingénieur — Centrale-Supélec & CCINP 2025), ajoutées par la tâche jury-enrichissement-hebdo (ajout pur, aucune entrée existante modifiée). */
/* v232 — NOYAU ESSENTIEL PAR CHAPITRE (demande de l'eleve : au plus 20 cartes essentielles PAR CHAPITRE). Scan complet des 1996 cartes scientifiques de TSI1 par 30 agents (15 selections chapitre par chapitre + 15 controles adverses charges de repecher tout fondamental ecarte et d'ejecter les doublons gardes), le programme officiel 2021 servant d'arbitre de l'exigible. RESULTAT : 7 chapitres <=20 cartes gardes entiers (112 cartes) ; 51 chapitres tries -> 1001 essentielles (43 chapitres pleins a 20, aucun hors bornes, zero indice hors chapitre au controle croise). Bilan : 1220 cartes essentielles (maths 463, physique 529, SI 121, francais 107 inchange car deja trie a la main) et 883 en approfondissement. CE QUE CA CHANGE : par defaut, seules les essentielles sont INTRODUITES en nouvelles cartes et servies en entrainement libre ; les cartes deja apprises restent revisees quand elles sont dues (le filtre ne touche pas la file des dues) — aucune progression interrompue. Le commutateur « approfondissement » reactive tout, et son libelle est recale sur ce sens (noyau essentiel vs variantes/applications/complements). COHERENCE REMARQUABLE : les selections ont retrouve independamment les conclusions de l'audit de conformite v223 (projecteurs/symetries, trace et determinant d'ordre n ecartes comme hors TSI1 ; carte « limite de la derivee » exclue d'office ; principe des tiroirs absent du programme). Ajout du seul champ niveau : AUCUN enonce modifie (2103 identiques avant/apres), SRS intact. Sauvegarde : scratchpad/index.html.avant_noyau. */
/* v233 — PREMIERES CARTES DE TSI2 : chapitre « 1. Statique des fluides », premiere partie du cours (echelles, particule de fluide, notion de champ, champ de pesanteur), fichee depuis les notes manuscrites de l'eleve. 15 cartes, TOUTES en flashcard (l'eleve ne veut pas de QCM ni de texte a trou sur ce chapitre), 2 schemas FIG (particule de fluide dans le fluide macroscopique ; repere ascendant avec g vers le bas). CONFORMITE verifiee sur le programme officiel TSI2, theme 1, section 1.1 « Elements de statique des fluides dans un referentiel galileen » : forces surfaciques/volumiques, champ de pression, distinguer pression et pesanteur, relation dP/dz = -rho.g, P(z) pour un fluide incompressible et pour l'atmosphere isotherme, comparaison ocean/atmosphere. Une carte de cadrage liste ces capacites pour que l'eleve sache ou il va. POINT VERIFIE ET SIGNALE : la POUSSEE D'ARCHIMEDE n'est PAS au programme — le mot « Archimede » n'apparait ni dans le programme de TSI1 ni dans celui de TSI2 (recherche sur les deux textes) ; une carte le dit, en precisant qu'on peut l'employer a condition de savoir la redemontrer par les forces de pression. ERREUR DE COURS CORRIGEE : les notes portent « champ stationnaire : v(M,t) = v(t) ». C'est une inversion — stationnaire signifie independant du TEMPS, donc v(M) ; l'exemple de la riviere ecrit juste apres le confirme. Deux cartes traitent explicitement la confusion uniforme/stationnaire, qui est la faute la plus courante du chapitre. NUANCE D'ORDRE DE GRANDEUR : le « ~10^23 » porte en marge du schema de la particule de fluide est le nombre de molecules d'une PIECE ; une particule de fluide en contient bien moins (~10^7 pour un cube de 1 um). La carte le precise sans contredire le cours. Chapitre a 15 cartes, sous la limite de 20 du noyau essentiel ; aucune n'est marquee approfondissement. 2103 -> 2118 cartes, aucun enonce existant modifie, SRS intact. */
/* v234 — TSI2 MATHEMATIQUES : chapitre « 12. Equations differentielles lineaires », fiche du cours manuscrit (Lycee Chaptal, 9 pages). 20 cartes, toutes en flashcard, 2 schemas FIG : les courbes integrales qui ne se croisent jamais (theoreme de Cauchy d'ordre 1) et les trois regimes selon le signe du discriminant. Le chapitre est exactement a la limite de 20 du noyau essentiel. COUVERTURE : ordre d'une equation et rigueur de notation y' contre y'(x) ; ordre 1 (definition, solutions de l'homogene Ce^-A, structure de S_H comme droite vectorielle dont les solutions non nulles ne s'annulent jamais, y = y_P + y_H, variation de la constante, superposition, Cauchy et sa consequence geometrique) ; ordre 2 (definition, S_H de dimension 2, equation caracteristique et les trois regimes, y''+w2y=0, Cauchy a deux conditions, abaissement de l'ordre de Lagrange, changement de variable) ; systemes X'=AX (definition, structure de dimension n, Cauchy, resolution par diagonalisation en cinq etapes) ; recherche d'une solution particuliere ; carte de cadrage du programme. CONFORMITE verifiee sur le programme officiel TSI2 : le cours du professeur recouvre exactement la section « Equations differentielles lineaires ». Deux points portes sur une carte : le RACCORDEMENT DE SOLUTIONS est HORS PROGRAMME (le texte le precise deux fois, en ordre 1 et en ordre 2), de meme que les demonstrations du theoreme de Cauchy ; et le programme exige EN PLUS du cours l'equivalence entre une equation scalaire d'ordre n et un systeme de n equations d'ordre 1, la resolution de X'=AX quand A est diagonalisable OU TRIGONALISABLE, et les solutions particulieres developpables en serie entiere. PRECISION AJOUTEE : le cours ecrit l'equation caracteristique « d'inconnue r dans R » ; les cartes precisent qu'on la resout dans C, puisque c'est justement le cas Delta<0, a racines complexes conjuguees, qui produit le regime pseudo-periodique. Verifications : les 2 figures parsent, leurs primitives sont supportees et l'echantillonnage des 8 traces montre 100 %% des points dans le cadre ; rendu en navigateur sans erreur console ni LaTeX brut. 2118 -> 2138 cartes, aucun enonce existant modifie, SRS intact. */
/* v236 — TSI2 SI : nouveau chapitre « 10. Theorie des mecanismes : mobilite et hyperstatisme », fiche du chapitre 2 du cours (SII Lycee Chaptal, sequence 15). Le chapitre n'existait pas : aucun des 9 chapitres de SI en TSI2 ne couvrait la theorie des mecanismes. 20 cartes, toutes en flashcard, 2 graphes de liaisons (chaine ouverte contre chaine fermee ; graphe a deux boucles illustrant gamma = L - n + 1 = 2). COUVERTURE : hypotheses (solides indeformables, liaisons parfaites) ; degre de mobilite m et le piege m =/= degre de liberte d'une piece ; mobilites utile et interne avec m = mu + mi ; bielle-manivelle en pivots (m=1) contre spheres-spheres (m=2) ; determination de m par blocage sur le schema cinematique ; degre d'hyperstatisme h et isostatisme h=0 ; consequences pratiques ; tabouret 3 pieds contre chaise 4 pieds ; types de chaines ; nombre cyclomatique ; methodes cinematique et statique ; Ic et Is ; cas particulier de l'helicoidale (Ic=1, Is=5 a cause du pas) ; Ec = 6.gamma et Es = 6(n-1) ; les deux formules de mobilite et leurs formes condensees ; application ponceuse vibrante (h=1). CONFORMITE verifiee sur le programme de SII : competence « Modifier un modele de mecanisme afin de le rendre isostatique », connaissances mobilite / degre d'hyperstatisme / substitution de liaisons, positionnees au semestre S2 — donc EXIGIBLES DES LA FIN DE LA PREMIERE ANNEE, bien que le cours les traite en TSI2. Une carte le signale, avec la consequence : l'attendu final n'est pas seulement de CALCULER h mais de savoir MODIFIER le mecanisme pour le rendre isostatique. TROIS POINTS DE CADRAGE portes sur des cartes : le texte officiel precise que « l'identification des contraintes geometriques et dimensionnelles liees au degre d'hyperstatisme n'est pas exigible » (or le cours developpe beaucoup cet aspect) ; le cours signale lui-meme deux fois « pas au programme de TSI » pour le rang cinematique rc et le rang statique rs ; et le terme « nombre cyclomatique » n'apparait PAS dans le programme (0 occurrence) — c'est un outil de calcul legitime du cours, mais l'attendu porte sur m et h. Aucun doublon avec les 24 cartes de TSI1 touchant les degres de liberte : celles-ci portent sur les torseurs des liaisons, pas sur la mobilite d'un mecanisme. 2138 -> 2158 cartes, aucun enonce existant modifie, SRS intact. */
/* v235 — SIGNALEMENTS 29/08-01/09 (14 traités, propriétaire arthur.lesage05) : 7 CARTES SUPPRIMEES sur demande explicite (« carte inutile »/« retire ») — ph_newton (coordonnees du PFD), ph_cinetique (reaction « sans ordre »), ph_gaz_parfait (volume molaire phase condensee), ph_premier_principe (vaporisation isotherme), ph_optique_geo (source primaire/secondaire), ph_convertisseurs (champ tournant statorique, carte bis), ph_structure_prop (solvant protique) — contenu conserve dans les fiches de cours, aucun autre enonce touche. SCHEMAS : si_slci « gain pur K » (aucun schema) -> gain et phase traces en droites horizontales ; 3 cartes si_slci « marges sur Bode » (MG/M-phi) -> schema generique de methode de lecture ajoute (allure pedagogique, pas a l'echelle de l'enonce precis de chaque carte). BUG DECOUVERT ET CORRIGE AU PASSAGE : la carte « pile Daniell » (ph_oxydoreduction) affichait par erreur le schema d'une molecule d'eau (Lewis), tandis qu'une carte de geometrie plane (geoplan, cercle de diametre) portait le vrai schema de la pile Daniell — figures reassignees a la bonne carte chacune, + schema cercle/angle droit ajoute a la carte de geometrie. CONTENU : ph_molecules NH3 (reponse jugee trop longue) -> answer raccourci a l'essentiel, detail deplace en exp (rien perdu) ; ph_second_ordre dephasage a la resonance (contexte manquant) -> exp precise le circuit RLC serie et le caractere particulier (omega=omega0 seulement). DEJA RESOLUS, verifies dans le code, aucune edition necessaire : torseur cinematique (correctif du 28/08 bien en place) ; citation Francais-Philo sur Ion (correctif v229 bien en place, verifie aussi valable apres le passage de l'environnement parallele sur les 30 citations). Rebase effectuee sur HEAD v233 (qui avait entre-temps ajoute le champ niveau + 15 cartes TSI2) : les 14 correctifs ont ete reappliques sur cette base fraiche, aucune carte du parallele perdue. Aucun enonce q modifie hors les 7 suppressions demandees -> qHash/FSRS preserves partout ailleurs. 2111 cartes (2118-7). */
/* v237 — SI : trois chapitres repassent INTEGRALEMENT en essentiels, sur demande de l'eleve. Le tri du noyau (v232) avait ramene « 5. Cinematique des solides » de 97 a 20 cartes, « 6. Statique des solides » de 50 a 20 et « 7. Systemes asservis (SLCI) » de 87 a 20. L'eleve juge ces trois chapitres a conserver en entier : 174 marquages niveau:'approfondissement' retires (77 + 30 + 67). Ces cartes redeviennent donc introduites par defaut comme nouvelles cartes et servies en entrainement libre. NON TOUCHE : « 3. Chaine d'energie & electricite » reste trie a 20 sur 58, l'eleve ne l'ayant pas cite. Bilan SI : TSI1 passe de 121 a 295 essentielles sur 333 ; avec les 20 cartes du nouveau chapitre de TSI2, cela fait 315 essentielles sur 353 quand les deux annees sont revisees ensemble. Bilan general : 1445 essentielles sur 2151 cartes (maths 483, physique 540, SI 315, francais 107). Retrait d'un champ uniquement : aucun enonce modifie, 2151 avant et apres, SRS intact. */
/* v238 — SIGNALEMENTS DU 01/09 (console admin) : 20 remontees traitees. (A) SCHEMAS BUGGES — regression que j'avais moi-meme introduite : mes figures du chapitre de theorie des mecanismes portaient des accents LaTeX dans \text{} (« cha\^ine ouverte », « extr\^emes diff\'erents », « cha\^ine ferm\'ee »), que MathJax n'interprete pas et affiche litteralement. C'est EXACTEMENT le bug corrige en v149 et que j'ai reproduit. 5 labels rectifies avec les caracteres accentues, dont 2 plus anciens atteints du meme defaut (« parall\`eles », « s\'ecantes »). (B) 7 CARTES RETIREES sur demande (« a retirer », « inutile ») — le motif est net : l'eleve rejette les cartes de CADRAGE PROGRAMME. Retirees : les 2 cartes meta du chapitre de theorie des mecanismes (methodes hors programme ; ce que dit le programme), 3 cartes de statique des fluides (poussee d'Archimede au programme ? ; ce que demande le programme ; origine du signe moins de g), la carte bibliographique sur la place de L'Oeuvre dans les Rougon-Macquart, et la carte de citation sur Ion signalee deux fois. LECON RETENUE : ne plus produire de cartes « meta-programme » ; ces informations vont dans le changelog et dans mes reponses, pas dans des cartes a apprendre. (C) CARTE TROP LONGUE : « consequences pratiques d'un mecanisme hyperstatique » passait 582 caracteres de reponse en cinq points ; ramenee a trois points essentiels, les deux autres passant en explication. (D) CARTE MARQUEE FAUSSE : « enthousiasme » — l'eleve demande « qui a un dieu en soi » plutot que ma glose « le dieu dedans ». Formulation retablie, en gardant la precision qu'il s'agit d'une glose etymologique du grec et non d'un mot du traducteur. (E) DEFAUT STRUCTUREL SIGNALE (« question : quelle citation, reponse : aucune citation ») : consequence directe de la correction v229, qui a retire les citations verbatim des traductions non verifiables tout en laissant des enonces qui en promettaient une. 13 cartes examinees, 10 reellement incoherentes : leurs enonces passent de « Quelle citation… » a « Quel passage… , et ou le trouver ? ». Les enonces changent, donc la progression SRS de ces 10 cartes seulement repart de zero — elles etaient inutilisables en l'etat. (F) BALISES IMBRIQUEES : 3 cartes portaient <b><b>, autre sequelle de v229 (l'avertissement remplace se trouvait deja dans un <b>). Nettoyees. INCIDENT DE TRAVAIL : ma reecriture de la carte hyperstatisme a omis le guillemet fermant de exp:"…", ce qui cassait le module. Le garde-fou verif_deploiement.sh l'a intercepte avant tout deploiement — le fichier n'a jamais quitte la machine dans cet etat. 2151 -> 2144 cartes. Hors les 7 suppressions et les 10 reformulations assumees, aucun enonce touche. */
/* v239 — QUALITE DE REDACTION DES ENONCES, signalee par l'eleve sur une carte : « Sous quelles deux hypotheses TRAVAILLE toute la theorie des mecanismes ? » — une theorie ne travaille pas, elle REPOSE SUR des hypotheses. Formulation fautive, corrigee. Relecture des 50 enonces ecrits ces deux jours : 3 autres maladresses trouvees et rectifiees. « Que valent les inconnues Ic et Is » (« que valent » appelle des grandeurs chiffrees, pas une definition) -> « A quoi correspondent ». « que peut-on dire de l'annulation de ces solutions » (jargon inutilement lourd) -> « ces solutions peuvent-elles s'annuler ». « qu'en deduit-on pratiquement » (adverbe mal place) -> « en pratique ». RETIREE PAR COHERENCE : la derniere carte de cadrage programme, en mathematiques (« qu'est-ce qui est hors programme en TSI2 »). L'eleve en avait fait retirer quatre du meme type la veille sans signaler celle-ci ; le motif etant sans ambiguite, elle part avec les autres. Si elle manque, il suffit de le dire. 2144 -> 2143 cartes. Les 4 enonces reformules perdent leur progression SRS (cartes creees la veille, perte negligeable) ; aucun autre enonce touche. */
/* v240 — STATIQUE DES FLUIDES : integration du paquet Anki distribue par la professeure (« Mecanique des Fluides — Statique », 13 notes lues dans la base .apkg, format anki21b/zstd). TRI AVANT AJOUT, comme demande : 8 notes etaient des doublons de cartes deja en place (fluide = liquide ou gaz ; champ homogene ; champ stationnaire ; champ scalaire ; direction/sens de la force de pression ; force volumique de pesanteur) et sont ecartees. 5 retenues, qui portaient le coeur exigible encore absent du site (verifie sur TOUTES les cartes, pas seulement le chapitre) : (1) la RELATION FONDAMENTALE dP = -mu.g.dz, avec le signe selon l'orientation d'Oz en explication et une mise en garde : la note d'origine du paquet ecrivait « dP = -mu g z » SANS le dz — formule fausse (une differentielle egalee a une fonction), corrigee ici ; (2) fluide INCOMPRESSIBLE (definition + masse volumique constante, deux notes de la prof fusionnees) ; (3) OCEAN : croissance lineaire, ~1 bar tous les 10 m, verification numerique en explication ; (4) ATMOSPHERE ISOTHERME : decroissance exponentielle P = P0.e^(-z/H), H = RT/Mg ~ 8 km, avec la comparaison ocean/atmosphere (capacite exigible) et un schema des deux allures ; (5) masse molaire moyenne de l'air, 29 g/mol. Notation : mu pour la masse volumique, comme la prof, avec la mention « aussi notee rho ». Le chapitre passe de 12 a 17 cartes, sous la limite de 20 du noyau. Toutes en flashcard (les vrai/faux du paquet sont reformules en questions ouvertes). INCIDENT INTERCEPTE : l'insertion a produit une double virgule dans le tableau (la carte precedente avait garde sa virgule apres un retrait antebrieur) — bloquee par verif_deploiement.sh avant tout deploiement, meme cause que la panne v206 mais cette fois le garde-fou a fait son travail. 2143 -> 2148 cartes, aucun enonce existant modifie, SRS intact. */
/* v241 — STATIQUE DES FLUIDES, partie II du cours manuscrit : compressibilite et bilan mecanique. Le chapitre atteint 20 cartes sur 20 (limite du noyau essentiel), avec 4 schemas. 3 CARTES AJOUTEES : (1) DEMONSTRATION de mu = MP/(RT) pour un gaz parfait, portee « demo a connaitre » et soulignee dans le cours ; (2) BILAN MECANIQUE sur une particule de fluide — systeme isole, poids comme force volumique, forces de pression comme forces surfaciques, deuxieme loi de Newton avec a = 0, projection — avec un schema du parallelepipede portant P(z)dS vers le haut, P(z+dz)dS vers le bas, le poids et la cote dz ; (3) ETABLISSEMENT de dP/dz = -mu.g, la demonstration complete en cinq etapes (page fournie separement, portee en rouge « Relation a connaitre ET la demo aussi »). Cette derniere est distincte de la carte qui demande la formule : le programme emploie le verbe « etablir », donc la demonstration est exigible en propre. 2 CARTES ENRICHIES au lieu d'etre dupliquees, dans answer/exp donc sans toucher aux enonces : « fluide incompressible » recoit la nuance du cours — incompressible ne signifie pas pression constante, c'est le VOLUME qui ne varie pas, la pression varie bel et bien ; « masse molaire de l'air » recoit la composition retenue en cours (80 % N2 / 20 % O2, qui redonne bien 28,8 ~ 29) avec les valeurs exactes en regard. RIGUEUR : la prise de notes ecrit « PV = mRT » dans la demonstration de mu ; la loi s'ecrit PV = nRT avec n = m/M, et c'est ce passage qui fait apparaitre la masse molaire. Le resultat du cours, mu = (P/T)(M/R), est juste ; la carte donne le chemin correct et signale le point de vigilance. 2148 -> 2151 cartes. Aucun enonce existant modifie, SRS intact. Les 4 figures du chapitre verifiees : parse, primitives supportees, 156 points echantillonnes, aucun hors cadre. */
/* v242 — FIN DU PLAFOND DE 20 CARTES PAR CHAPITRE (demande de l'eleve : chaque notion doit avoir sa carte pour etre apprenable, definitions / formules / demonstrations comprises). Le « max 20 » ne valait que pour le TRI DES ESSENTIELS en TSI1 (filtre approfondissement) ; il avait ete reporte a tort sur la CREATION de chapitres a partir d'un cours. Regle abandonnee pour tous les chapitres construits depuis un cours. Statique des fluides : 5 notions du cours n'avaient pas de carte PROPRE (elles n'existaient qu'a l'interieur de la reponse d'une autre carte, donc non revisables en tant que telles) — chacune recoit desormais la sienne : (1) definition d'un fluide (liquide ou gaz) ; (2) masse volumique mu = m/V avec unite kg.m-3 ; (3) force de pression dF = P dS, direction et sens ; (4) force volumique de pesanteur f = mu.g ; (5) composition de l'air (80 % N2 / 20 % O2). Toutes essentielles (aucune marquee approfondissement), toutes en flashcard. Le chapitre passe de 20 a 25 cartes. 2151 -> 2156 cartes, aucun enonce existant modifie, SRS intact. */
/* v243 — « SYNC SRS ECHOUEE » EN BOUCLE, signale par l'eleve. Diagnostic impossible en l'etat : le message etait generique et le code Firebase, seul element permettant de trancher, restait cache dans la console. Deux changements, tous deux dans SRS._syncCloud. (1) LE CODE D'ERREUR EST DESORMAIS AFFICHE dans le bandeau : « Sync SRS echouee — permission-denied » (regles Firestore ou jeton App Check refuse), « resource-exhausted » (quota Firestore du jour epuise), « invalid-argument » (document au-dela de la limite), « unavailable » (reseau). Sans ce code il etait impossible de distinguer quatre causes aux remedes opposes. (2) GARDE-FOU DE TAILLE : Firestore refuse tout document de plus de 1 Mio, et la sauvegarde SRS ecrit un document unique users/{uid} contenant l'etat de toutes les cartes vues plus 1000 entrees de journal. Passe ce seuil, chaque sauvegarde echoue indefiniment sans que l'eleve puisse rien faire. Le paquet est maintenant mesure avant l'envoi et le JOURNAL est rogne par moitie jusqu'a repasser sous 800 Ko — le journal ne sert qu'aux statistiques de retention. Les CARTES ne sont jamais tronquees : c'est la progression. Cause encore indeterminee a ce stade : App Check (reCAPTCHA v3) est actif sur ce projet et un jeton refuse produirait exactement ce symptome, mais le quota et la taille restent possibles. Le code affiche tranchera. Aucune carte touchee (2156 avant et apres). */
const CACHE = 'quiz-tsi-v253';  /* ── v253 SIGNALEMENTS — TRAITEMENT DES 170 REMONTÉES ACCUMULÉES DEPUIS L'OUVERTURE DU SITE. La collection n'ayant jamais été purgée, chaque signalement a d'abord été CONFRONTÉ à l'état actuel de la carte plutôt que corrigé à l'aveugle (4 agents, un par matière) : 83 déjà corrigés par des versions ultérieures, 22 portant sur des cartes depuis supprimées, 40 encore ouverts, 20 à arbitrer avec l'élève. CORRECTIF SYSTÉMIQUE, cause de 8 remontées répétées : l'amorce des énoncés-PRÉMISSE (« Système de Cramer (…) : », « $\cos(a+b)=$ ») posée en v148 ne l'était que dans le moteur QCM et le mode examen, JAMAIS dans renderFlash — c'est-à-dire dans le mode de révision, le seul que l'élève utilise. D'où « PAS DE QUESTION » signalé cinq fois, dont trois APRÈS le correctif. flashHint affiche désormais « Complète l'énoncé de mémoire » sur ces cartes. NEEDS_CHOICES_RE étendu aux tournures « quelle proposition / implication / affirmation… », qui renvoient elles aussi aux propositions d'origine. SCHÉMAS AU RECTO (le reproche le plus répété, jusqu'à « 50 fois que je signale ») : les 8 cartes de changements de base successifs portaient leur figure en 'fig', donc au VERSO ; elles passent en 'qfig'. SEPT FIGURES CRÉÉES OU COMPLÉTÉES, dessinées puis contre-vérifiées par un second agent qui les a rendues à l'écran : bielle-manivelle pivots contre sphère-sphère (recto), tabouret 3 pieds contre chaise 4 pieds, les trois types de chaînes de solides (la chaîne complexe manquait), schéma cinématique pour la méthode du blocage virtuel, les trois types de translations, réponse indicielle avec le tube ±5 %, et le second arc θ qui manquait à la figure de changement de base 1. La vérification a rattrapé un défaut invisible au calcul : sur la chaise, le décrochement du sol et le pointillé de jeu se lisaient à l'écran comme un seul trait, le quatrième pied semblait donc toucher le sol. AUTRES CORRECTIFS : « Misplaced & » (un & de tableau LaTeX employé en ligne) sur la carte du piège pivot glissant / hélicoïdale ; l'énoncé « Citer les trois propriétés du torseur cinématique (antisymétrie, changement de point, composition) » donnait les réponses dans la question — la parenthèse est retirée (seul énoncé modifié, donc seule carte dont la progression repart). CONSOLE ADMIN : les signalements traités peuvent désormais être marqués d'un clic (écriture Firestore, repli automatique sur un marquage local si les règles la refusent), le compteur distingue ouverts et total, une case masque les traités, et un bouton exporte tout en JSON. Sans cela les 170 remontées déjà réglées reviennent à chaque ouverture de la console. */  /* ── v252 SI TSI1 — LES 52 CARTES QUI MANQUAIENT AU PROGRAMME DE PREMIÈRE ANNÉE. Analyse de manques croisant le programme officiel SII TSI 2021 (S1-S2), les notions réellement mobilisées par les 9 exercices du DS blanc, et les 300 cartes SI déjà en ligne : quatre agents ont cherché les trous, quatre autres ont contre-vérifié (confiance haute partout, doublons et hors-programme supprimés). Répartition : Cinématique +16, Statique +12, Transmission de puissance +13, Théorie des mécanismes +7, Liaisons +4. MANQUES LES PLUS PARLANTS, tous au programme et pourtant absents : l'ÉQUIPROJECTIVITÉ du champ des vitesses (zéro carte), le CENTRE INSTANTANÉ DE ROTATION (définition et détermination graphique), la notion de POINT COÏNCIDANT (le sens de la notation M appartenant à S quand M n'est pas un point matériel de S), le tracé d'une FIGURE DE CHANGEMENT DE BASE (les cartes existantes donnaient les formules sans jamais dire comment les obtenir), les CONDITIONS ET LIMITES DE LA MODÉLISATION PLANE (supposées partout, énoncées nulle part), le SCHÉMA CINÉMATIQUE MINIMAL, le transport du moment d'un torseur d'actions mécaniques, l'approche STATIQUE des liaisons en série, la méthode du repère lié au PORTE-SATELLITE, la relation de Willis développée (Ravigneaux) et la condition d'entraxe d'un train épicycloïdal. Le chapitre 8 « Transmission de puissance » passe à 31 cartes et le 9 « Théorie des mécanismes » à 28 ; la SI compte désormais 439 cartes, toutes en TSI1. Aucun énoncé existant modifié → progression FSRS intacte. */  /* ── v251 RÉVISION DE DS — nouveau mode « DS blancs » (bouton 📝 dans l'en-tête) + DS n°1 de SI (mécanique, samedi 6 septembre). MODE : un DS blanc = (1) le COURS À MAÎTRISER, révisé par le moteur SRS habituel, avec deux boutons — « L'essentiel du DS » (94 cartes, sélection par règles évaluées sur les énoncés au chargement, donc rien à maintenir quand une carte change) et « Tout le programme du DS » (219 cartes) — et (2) une BANQUE D'EXERCICES corrigés issus des TD de la classe : énoncé, schémas rognés dans les scans, questions une à une avec coup de pouce, correction rédigée, auto-évaluation juste/partiel/faux, score courant, note sur 20, « ce que regarde le correcteur », historique local (dsLog) et meilleure note par exercice. Nouvelle fonction startReviewForHashes : révision d'une liste de cartes, sans quota du jour, notations alimentant le SRS normalement. CONTENU DU DS n°1 : 9 exercices, 75 questions, 180 points, 31 schémas — liaisons équivalentes en série (les 6 montages du TD 28, un schéma par question), groupe hydraulique de Serre-Ponçon, mât réacteur A320, pompe à pistons axiaux, tendeur de courroie, machine de traction/torsion, robot 2 axes, pince lève-tôle (PFS + Coulomb), trains d'engrenages et poulie Redex (Willis). Chaque exercice a été rédigé depuis les scans puis CONTRE-VÉRIFIÉ par un second agent qui a refait tous les calculs (confiance haute sur les 9) : la vérification a notamment rattrapé un repère inversé sur le tendeur (guides selon z et non x — tous les torseurs et le nom de la liaison équivalente étaient faux) et une condition géométrique erronée sur l'hyperstatisme. CARTES : +36 cartes de cours vérifiées, dont un chapitre entier « 8. Transmission de puissance » (18 cartes : rapport de transmission, engrenages extérieur et intérieur, module, entraxe, trains simples, roue et vis sans fin, vis-écrou, pignon-crémaillère, poulies-courroie, train épicycloïdal et méthode de Willis) qui manquait totalement au site, 9 cartes de frottement de Coulomb (adhérence, glissement, cône, arc-boutement) et 9 cartes de liaisons équivalentes et d'hyperstatisme. PROGRAMME : le chapitre « Théorie des mécanismes : mobilité et hyperstatisme » passe de TSI2 à TSI1 — l'arrêté du 9 juillet 2021 le place en semestre S2 de première année ; il était donc invisible pour un élève de TSI1 alors qu'il est au programme du DS. Aucun énoncé existant modifié → progression FSRS intacte. */  /* ── v250 PARADE DURABLE POSEE cote Firestore. Exemption d'index mono-champ appliquee sur users.srs et users.agg (gcloud firestore indexes fields update <champ> --collection-group=users --database='(default)' --disable-indexes). Elle se propage a toute la descendance par heritage (srs.cards.<hash>.<champ> a pour ancetre srs — verifie via l'API), ce qui ramene la contribution de la progression et des statistiques aux entrees d'index de ~35 900 a ZERO : le plafond des 40 000 n'est plus atteignable, pour l'eleve comme pour toute la classe. Sans effet de bord : les deux seules requetes du code portent sur `sessions` et `reports`, triees par date — rien ne requete a l'interieur de srs/agg (verifie par grep where(/orderBy()). profile et email gardent leur indexation normale. CONSEQUENCE COTE CLIENT : la garde de _paquetCloud() repasse en OCTETS (budget 700 Ko), puisque la seule limite qui subsiste est celle des 1 Mio par document — le budget en entrees d'index de v249 rognait desormais le journal a 250 lignes pour rien ; il remonte a 1 000. Le compte d'entrees reste calcule et journalise au-dela de 30 000, comme filet de diagnostic si l'exemption venait a sauter. */  /* ── v249 SYNCHRO SRS RÉPARÉE — la vraie cause du « Sync SRS échouée — invalid-argument ». Ce n'était PAS le poids : mesure sur la base réelle le 05/09/2026, le document le plus lourd faisait 319 Ko, soit 30 % de la limite de 1 Mio. La limite franchie était l'AUTRE : Firestore refuse tout document au-delà de 40 000 ENTRÉES D'INDEX (2 par valeur scalaire, maps et tableaux compris). Document stocké = 35 898 entrées (90 %) ; + 1 000 lignes de journal (5 champs = 10 entrées chacune) = 45 898 → refus systématique. Le repli « sans journal » repassait dessous et réussissait : c'est pourquoi reviewLog restait à 0 dans le cloud pour ce compte alors que des comptes plus légers (8 278 entrées) gardaient le leur. Trois correctifs : (1) saveSRS passe de setDoc(merge:true) à updateDoc — merge fusionne les maps mais ne SUPPRIME jamais une clé, si bien que l'allègement de v244 n'avait aucun effet : 881 énoncés q, 148 cartes orphelines et 170 hachages de l'ancien format étaient figés au cloud (8 204 entrées de poids mort) ; updateDoc écrase le champ srs en entier et les efface enfin. (2) La garde mesure désormais les ENTRÉES D'INDEX (budget 24 000) et non des octets — l'ancien seuil de 800 Ko ne pouvait jamais se déclencher et ne mesurait pas la bonne grandeur ; le journal est rogné pour tenir, les cartes jamais. (3) manualSync() partageait enfin le même paquet : il envoyait les cartes BRUTES, énoncés compris, et réinjectait à chaque clic le poids que la synchro automatique venait d'ôter. Vérifié sur les données réelles : 45 898 → 30 420 entrées, ~9 580 de marge, et le journal (250 lignes) monte enfin au cloud. Message d'erreur réécrit en « Synchro différée … (progression gardée sur cet appareil) » : la progression locale n'a jamais été en danger. RESTE À FAIRE pour rendre la parade définitive quand le paquet complet sera appris : exemption d'index mono-champ sur users.srs et users.agg dans Firestore. */  /* ── v248 ANGLAIS — VERSOS CONCIS (même demande que pour le français : « je suis censé apprendre par cœur »). Les 28 cartes d'anglais gardent leur énoncé (qHash/SRS intacts) ; answer et exp réécrits : réponse médiane 165→~110 caractères, explication 181→~150 (les deux cartes-listes PM/présidents conservent leur liste, c'est le contenu à réciter). La carte de synthèse « Social media and minors » (7 pays d'un bloc) est retirée : elle doublait les 7 cartes par pays. Faits post-poly intacts (Burnham PM 20/07/2026, Angela Eagle DEFRA, Lee Zeldin EPA). Vérification adverse 3 agents (fidélité factuelle vs version précédente, langue anglaise + français des exp, intégration JS) : 0 bloquant, corrections intégrées (COPPA fédérale mais données seulement ; « non-compliant platforms » ; Forbes 400 défini ; « au Royaume-Uni » pour Thatcher ; articles A/An, appositions, phrases complètes). En plus, au verso des flashcards d'ANGLAIS l'explication est désormais REPLIÉE derrière « Détails et pièges » (même mécanisme que le français, helper expHTML) : la réponse à apprendre apparaît seule. */  /* ── v247 FRANÇAIS — TRI DE PERTINENCE CONCOURS : 105 → 40 cartes. À la demande de l'élève (« 105 fait déjà beaucoup, je n'ai encore fiché aucun cours ; garder les meilleures dans le contexte des concours écrits »). Enjeux établis sur sources : programme officiel 2026-2027 (Platon Ion trad. Canto-Sperber + République X 595a-608b trad. Leroux ; Zola L'Œuvre ; Woolf Un lieu à soi trad. Darrieussecq) ; épreuves TSI = CCINP/e3a français-philo (résumé /10 + dissertation /20) et Centrale-Supélec Rédaction (résumé 200 mots + dissertation ~1200 mots sur les œuvres) ; rapports de jury CCINP/e3a 2025 et 2021 (« références précises, analysées et commentées », « confrontation des œuvres indispensable », « les citations ne sont pas attendues », sanction de la récitation et des inventaires). Évaluation par workflow : 3 juges indépendants par chapitre (lentilles correcteur / professeur de CPGE / élève stratège, grille 0-3) + 1 juge des doublons inter-chapitres ; conservée si moyenne ≥ 2,5 (au moins deux 3/3), zone 2,0-2,5 repêchée seulement pour la couverture minimale par œuvre, doublons inter-chapitres retirés. Résultat par chapitre : Ion 5/10, République X 7/12, Zola 6/11, Woolf 7/18, thème 2/5, notions 3/16, citations 3/23, exemples de dissertation 7/10. Retraits : 30 zone grise (nuances, exemples secondaires), 17 doublons inter-chapitres, 14 notes faibles (anecdotes, biographie, méthode générale, résumés d'intrigue), 4 HORS PROGRAMME dont 2 cartes qui attribuaient à 607a (livre X) l'image du poète couronné, parfumé et reconduit hors de la cité — qui est en République III 398a : référence FAUSSE qui aurait coûté des points ; + Timée, Aristote poïésis/praxis. Les 65 cartes retirées sont archivées (scratchpad/tri/cartes_retirees_francais.json + index.html.avant_tri_francais) et réinjectables ; la progression SRS sur ces 65 cartes est purgée par gc() au chargement (conséquence assumée du tri). Aucune carte conservée modifiée. */  /* ── v246 QUATRE DEMANDES ÉLÈVE (rentrée TSI2). (1) FRANÇAIS — CONCISION : les 105 versos (answer+exp) réécrits, énoncés q INTACTS (qHash/SRS préservés). Le verso cumulait réponse + explication ≈ 420 caractères en médiane (jusqu'à 900) : réponse médiane 175→134 car. (max 177), explication 242→165 (max 211). Production par workflow 16 agents (rédacteur + vérificateur adverse par chapitre : q au caractère près, citations « » mot pour mot, références Stephanus/chapitres, aucun fait ajouté) puis contrôle mécanique indépendant : 0 défaut. En plus, au verso des flashcards de FRANÇAIS l'explication (référence, contresens) est REPLIÉE derrière « Référence et pièges » (details/summary natif) : la Réponse à apprendre par cœur apparaît seule ; ailleurs l'explication reste dépliée (démonstrations, schémas). (2) MODE COURS « ne marche plus » : il filtrait par inScopeOf (matière ET niveau actif) → un élève passé en TSI2 ne voyait que les chapitres TSI2, sans aucune fiche → « Aucune fiche de cours ». Désormais toutes les fiches de la matière, badge TSI1/TSI2, TSI1 d'abord. (3) CLASSEMENT « out » : filtré sur l'année déclarée → un élève passé en TSI2 se retrouvait SEUL tant que ses camarades (entrée figée sur l'année d'inscription) n'avaient pas déclaré leur passage. Onglets « Ma classe » / « Toute la prépa » (badge d'année), bascule auto sur la prépa si la classe compte < 2 participants, message expliquant comment les camarades apparaîtront ; fraîcheur : « cartes de la semaine » remise à 0 au-delà de 7 jours sans publication. (4) COMPTEUR « Questions » faux (déjà signalé) : agg.totalAnswered n'est alimenté que par les sessions sauvegardées — sauvegardes qui ont ÉCHOUÉ pendant toute la période document > 1 Mio (v244) et qui manquent les sessions fermées sans bilan. Réconciliation : max(cloud, Σ reps SRS local) ; si le SRS domine, le taux de réussite affiché est celui du journal local (réel). Testé : 22 au lieu de 3, 75 %. Aucun énoncé modifié → progression FSRS intacte. */  /* ── v245 ANGLAIS — PREMIÈRES CARTES DU SITE (29, poly de colles TSI2 Week 1-2, rubriques « Know your stuff » et « Revise your sources ») + nouveau chapitre « 14. Civilisation : médias et monde numérique » (en_civ_medias, family en_civ, tr). Répartition : en_civ_uk 8 (liste des PM depuis 1979, Thatcher, Blair/Brown, les 5 conservateurs 2010-2024, Truss 49 jours, Starmer 2024-2026, NOUVEAU PM Andy Burnham depuis le 20/07/2026, DEFRA) ; en_civ_us 7 (liste des présidents depuis 1961, JFK, Nixon/Watergate, Reagan, Obama, mandats non consécutifs de Trump, EPA) ; en_civ_medias 14 (6 sources de presse : Guardian, Economist, Washington Post, Wired, The Conversation, Forbes ; 7 législations réseaux sociaux par pays + carte de synthèse). Énoncés/réponses en ANGLAIS (restitution de colle), explications en français. FAITS POST-POLY VÉRIFIÉS le 03/09/2026 (le poly, imprimé avant l'été, est périmé sur deux points) : Andy Burnham PM depuis le 20 juillet 2026 (gov.uk + CNN + ABC, succède à Keir Starmer, 7e PM en une décennie) et Angela Eagle au DEFRA depuis le 20/07/2026 (NFU, Farmers Guide, Water Magazine — le poly indique encore Emma Reynolds, devenue Chief Secretary to the Treasury) ; les cartes signalent explicitement ces mises à jour à l'élève. Production vérifiée par workflow adversarial 7 agents (fidélité au poly page par page, faits hors poly par recherche web, langue anglaise, intégration technique) : 2 erreurs bloquantes intersceptées avant mise en ligne (date de leadership Labour contestée entre sources -> retirée ; titulaire DEFRA périmé -> corrigé), ~25 corrections de langue appliquées (idiomes, guillemets anglais dans les champs anglais, typographie). Testé en local : 2185 cartes chargées (2156+29), 0 collision qHash, rendu HTML des réponses vérifié au DOM. Aucun énoncé existant modifié -> progression FSRS intacte. */  /* ── v244 SYNC SRS RÉPARÉE (cause racine du « invalid-argument » en boucle) + 2 demandes élève. (1) SYNC : chaque entrée SRS locale stockait l'ÉNONCÉ complet de sa carte (champ q, format historique) et l'envoyait au cloud — sur ~1500 cartes vues, des centaines de Ko de poids mort qui faisaient crever au document users/{uid} (progression + stats + profil) la limite Firestore de 1 Mio : CHAQUE sauvegarde échouait, d'où le toast permanent. Le paquet cloud est désormais ALLÉGÉ (sans énoncé — le hash est la clé, l'énoncé se retrouve dans QUESTIONS —, S/D arrondis à 4 décimales, champs null/NaN éliminés) ; mergeCloud réinjecte q/topic depuis la banque locale à la fusion (lecteurs historiques intacts) ; le stockage LOCAL n'est jamais modifié. Dernier filet : si le doc déborde encore (surpoids venu des stats agrégées), nouvel essai sans le journal — la progression passe avant tout. Testé en local : paquet -33%% déjà sur 3 petites cartes, q retiré partout, local intact, réinjection vérifiée. (2) QUIZ PERSONNALISÉ : les cartes NON SUES (jamais vues, en apprentissage, ou retombées après un échec) passent désormais TOUJOURS avant les cartes sues, quel que soit le quiz — partition stable avant la coupe à N questions, donc elles remplissent le quiz en priorité ; l'examen blanc garde son tirage aléatoire (représentativité). (3) NOUVELLES DU JOUR ÉQUITABLES : le tirage uniforme favorisait la matière au plus gros stock de cartes jamais vues (l'élève voyait « beaucoup de français ») ; les 20 nouvelles sont désormais servies en TOURNIQUET par matière (une de chacune à tour de rôle, mélange interne par matière) — vérifié en local : 5 maths / 5 physique / 5 SI / 5 français là où les stocks sont 921/779/351/105. Aucun énoncé q modifié → qHash et progression FSRS intacts. */  /* ── v226 SIGNALEMENTS 28-29/08 (6 cartes) : Laplace « positions d'equilibre » -> le schema ne montrait QUE la position stable alors que la question en demande deux (nouveau schema a 2 panneaux theta=0 stable / theta=180 instable + exp sur le critere energetique) ; gaz parfait sous piston -> le schema etait un bilan de puissance de MOTEUR (aucun rapport), remplace par le cylindre+piston avec P0S/mg/PS ; Bode d'ordre 1 (K=3, w0=0,5) -> schema gain+phase ajoute (premiere figure utilisant box:[l,h]) + methode de lecture en exp ; surtension a la resonance -> contexte RLC serie, definition, condition Q>1, exemple chiffre ; impedance a la resonance -> circuit precise (RLC serie) + mise en garde circuit bouchon ; integrale par changement de variable -> la reponse esquivait la substitution demandee, elle est desormais menee (bornes comprises). Aucun enonce modifie -> qHash et FSRS intacts. */  /* ── v225 FLASHCARDS ISSUES D'UN QCM : correctif de FOND. toFlashCard() retire les propositions ; les enonces qui y renvoient (« Parmi ces molecules, laquelle… », « Lequel de ces… ») devenaient incomprehensibles en revision (signale au moins 4 fois, corrige jusqu'ici carte par carte). Le rendu flashcard reaffiche desormais la liste, melangee et sans marquer la bonne reponse, UNIQUEMENT quand l'enonce y renvoie (detection needsChoicesQ : 10 cartes sur 166 QCM mesurees) — partout ailleurs le rappel libre est preserve, car il vaut mieux pour la memorisation. Aucun enonce modifie -> qHash et FSRS intacts. */  /* ── v224 SIGNALEMENTS : (1) DEPLOIEMENT des 24 corrections de contenu du 28/08 restees bloquees en local et jamais poussees (exp/fig/answer uniquement, q intacts → SRS préservé), greffées carte par carte sur HEAD v223 ; + 2 cartes retirées à la demande explicite du propriétaire (alcane ramifié, loi de vitesse par suivi temporel). (2) FIX vue admin : Cloud.getReports était plafonné à limit(50), le compteur « Signalements (50) » était donc un PLAFOND et non un total, et tout signalement au-delà du 50e plus récent était invisible → plafond porté à 500 et suffixe « + » affiché si le plafond est atteint. */  /* ── v172 (session parallèle) MOT DU JURY : +13 entrées Centrale-Supélec TSI 2026 (maths, physique-chimie, SI), ajoutées à JURY_DATA. */  /* ── v160 SYNC AUTO 2026-08-21 : greffe sur HEAD v159 des 3 correctifs produits en local par la tâche signalements du matin (chapitre ph_laplace) — balises <b> échappées (\lt b\gt) restaurées dans deux champs answer, et explication de la carte « position theta=180° instable » enrichie (situation posée + argument énergétique E_p=-m.B). Champs answer/exp uniquement — aucun énoncé q modifié → qHash et progression FSRS intacts. */  /* ── v150 PERTINENCE DES SCHÉMAS + LISIBILITÉ DES CONSIGNES. (A) FIGURES MAL AFFECTÉES : la relecture des 96 planches a mis au jour un DÉCALAGE SYSTÉMATIQUE dans le bloc des cartes vrai/faux de physique — la figure portée par la carte N appartenait en réalité à la carte N-1. 12 réaffectations vérifiées une à une : ARQS (convention récepteur, loi d'Ohm en convention générateur, résistances internes ampèremètre/voltmètre, association en parallèle, source idéale de courant), cinématique (déphasage bobine/condensateur, relation a-v, vitesse tangente), mécanique (décomposition de la réaction, 3e loi de Newton Terre-Lune, travail du poids indépendant du chemin, travail de la réaction). La carte sur la convention récepteur affichait un schéma d'OPTIQUE. (B) 9 FLÈCHES DE TENSION INVERSÉES : sur les dipôles R, C et L, u était fléchée dans le MÊME sens que i, c'est-à-dire en convention générateur, alors que les cartes énoncent les relations de la convention récepteur (u=Ri, i=C du/dt, u=L di/dt). (C) LIGNES BRISÉES : un `segment` de plus de deux points n'était tracé que sur ses deux premiers points — le reste de la trajectoire disparaissait et les vecteurs posés dessus semblaient flotter. (D) CONSIGNES : l'amorce des QCM couvre désormais les énoncés suspendus par des points de suspension (« se comporte comme… », 29 cartes) ; et les flashcards dont l'énoncé est un simple INTITULÉ de point de cours (« Inégalité des accroissements finis. », une centaine de cartes) reçoivent une invite explicite « Énonce ce point de mémoire — définition, formule ou théorème — puis révèle », au lieu de l'invite générique. Aucun énoncé q modifié → qHash et FSRS intacts. */  /* ── v149 AUDIT COMPLET DES SCHÉMAS (702 figures rendues une à une avec MathJax et mesurées au pixel) — CORRECTIFS MÉCANIQUES. (1) 20 FIGURES NE S'AFFICHAIENT PAS : les champs fig de 10 cartes de filtrage appelaient L10() et 10 cartes de résonance appelaient Q, deux aides JAMAIS DÉFINIES ; l'exception était avalée par le try/catch du normaliseur, la carte s'affichait sans son schéma. L10 (log décimal) est ajouté à côté de P(), et Q est remplacé par sa valeur explicite 4 — celle pour laquelle les points à -3 dB codés en dur (0,883 et 1,133) sont exacts — sauf sur les 2 cartes « influence de Q » qui tracent trois courbes et reçoivent 1,5 / 4 / 12. (2) DIAGRAMMES DE BODE ÉCRASÉS : 4,6 unités en abscisse contre 53 en ordonnée, avec l'échelle isotrope de FIG, donnaient un dessin de 28 px de large sur 330 de haut. FIG accepte désormais un champ box:[largeur,hauteur] qui donne une échelle propre à chaque axe (défaut isotrope INCHANGÉ, indispensable aux cercles et aux angles) ; les 7 figures de Bode passent en box:[320,210]. (3) CINÉTIQUE : sur la figure partagée par 19 cartes, « ordre 0 » et « ordre 1 » tombaient chacune sur la MAUVAISE courbe (« ordre 1 » sur la droite, « ordre 0 » près de l'exponentielle) — étiquettes repositionnées sur leur courbe. (4) CONVENTION RÉCEPTEUR (2 cartes) : la flèche u était dans le MÊME sens que i, c'est-à-dire la convention générateur, en contradiction directe avec la carte #1464 qui enseigne que les flèches sont opposées ; flèche u inversée. (5) ACCENTS LaTeX non interprétés par MathJax dans \text{} : « dip\^ole », « r\'ecepteur », « ap\'eriodique »… s'affichaient littéralement sur 7 figures — remplacés par les caractères accentués. (6) BALISES DE GRAS ÉCHAPPÉES : 14 énoncés affichaient « \lt b\gt Rails de Laplace.\lt /b\gt » en clair ; comme q est la clé du SRS et ne doit jamais changer, la réparation se fait à l'AFFICHAGE (fonction qHTML, appliquée à la révision et au mode examen, sans toucher aux \lt/\gt légitimes des formules). Vérifs : 702 figures rendues, 0 exception (contre 20), 0 erreur MathJax, qHash et ordre des cartes inchangés. */  /* ── v148 QCM À ÉNONCÉ-PRÉMISSE — amorce d'affichage (signalement SYSTÉMIQUE : au moins 7 remontées, 3 comptes, sur Cramer x3, suites adjacentes, approche énergétique, nombres complexes et inégalité des accroissements finis, toutes du type « pas de question » / « pas lisible »). Beaucoup de QCM posent une PRÉMISSE : l'énoncé se termine par « : » (« Système de Cramer (…) : ») ou reste suspendu sur un opérateur (« $\cos(a+b)=$ ? »), et l'élève ne voit pas ce qui est demandé. Correctif au niveau du RENDU, PAS du contenu : nouvelle fonction isPremiseQ() (détection sur « : » final ou opérateur suspendu après retrait du « ? » et du « $ » de fin) ; quand elle répond vrai, une ligne discrète « Choisis la proposition qui complète l'énoncé. » (classe .qcm-lead, 13 px, italique, couleur --muted) est insérée entre l'énoncé et les propositions. Appliqué aux DEUX rendus de QCM : renderQCM (révision et quiz) et renderExamQuestion (mode examen). Mesure sur le corpus : 258 des 397 cartes QCM concernées ; les vraies questions interrogatives ne déclenchent jamais l'amorce (6 cas de contrôle vérifiés). AUCUN énoncé q n'est modifié → qHash et progression FSRS intacts ; design, thèmes et localStorage inchangés. Réglage/retrait = une ligne (PREMISE_LEAD / isPremiseQ). */  /* ── v147 RÉCUPÉRATION DU CORRECTIF DE LA TÂCHE SIGNALEMENTS DU MATIN : le run « signalements-check-tsi » du 2026-08-19 08h53 avait enrichi, dans le fichier LOCAL uniquement, l'explication de la carte « Inégalité des accroissements finis » (signalement yannnzali8 : énoncé-prémisse perçu comme sans question) en rappelant l'énoncé complet |f(b)-f(a)| <= M|b-a|. Ce correctif n'avait jamais été poussé et a failli être perdu lors de la resynchronisation du dossier local sur v146 ; il est ici regreffé sur HEAD. Champ exp uniquement, énoncé q inchangé → qHash et progression FSRS préservés. */  /* ── v146 SCHÉMAS SUR CARTES DOUBLONS (backlog signalements, dernier reliquat) : deux cartes existaient en double, l'une avec figure et l'autre sans. La figure de la jumelle leur est greffée à l'identique — « Distance d'un point M_0(x_0,y_0) à la droite ax+by+c=0 » (mode flash) reçoit le schéma point / projeté / distance d de la carte en mode saisie, et « s ∈ L(E) est une SYMÉTRIE ⟺ ? » reçoit le schéma x / p(x) / s(x) de la carte « Définis une symétrie ». Ajout du seul champ fig : énoncés q, choix, réponses et explications INCHANGÉS → qHash et progression FSRS préservés. Premier déploiement réalisé par la chaîne de push NON INTERACTIVE (git + jeton fine-grained, sans Chrome) avec passage par guard-srs.py. */  /* ── v145 SIGNALEMENTS ÉLÈVES — 7 correctifs de contenu (énoncés q INCHANGÉS → SRS/FSRS préservé). MATHS : (1) carte « 5 exemples de fonctions bornées qui n'atteignent pas leurs bornes » — l'exemple 4 était FAUX (sur $]0,2\pi[$ le sinus atteint bien $\pm1$ en $\pi/2$ et $3\pi/2$) → remplacé par $]-\pi/2,\pi/2[$ ; exemple 3 ($e^{-x^2}$) précisé : seule la borne INFÉRIEURE n'est pas atteinte ; (2) variation de la constante — explication étoffée (pourquoi le terme en C s'élimine, $C'=be^{A}$, forme intégrale) ; (3) contre-exemple d'implication — les symboles $\wedge$ et $\lnot$ sont désormais nommés (« c'est quoi le chapeau ? »). PHYSIQUE : (4) diagramme d'AMAGAT — la figure montrait des hyperboles en axes $(V,P)$, c'est-à-dire un diagramme de Clapeyron, en contradiction avec la réponse de la carte : refaite en axes $(P,Pv)$ avec isothermes horizontales, limite $Pv\to RT$ et écart du gaz réel ; (5) Clapeyron liquide-vapeur (figure partagée par 6 cartes) — ajout du POINT CRITIQUE, des courbes d'ébullition et de rosée et du prolongement de l'isotherme hors du palier ; (6) carte $u_C$/$i_L$ après commutation — le schéma ne comportait AUCUNE bobine : deux circuits (a) RC et (b) RL, et explication de la continuité par l'argument de puissance ; (7) décrément logarithmique — explication ajoutée (c'était la seule carte du fichier au champ exp vide) : $T$, $\tau$, l'enveloppe, et $Q\simeq\pi/\delta$. Vérifs : 1551 cartes, qHash et ordre identiques, 701 fig / 19 ggb, 0 artefact Cloudflare, node --check OK.  /* ── v144 RÉCONCILIATION BASE LOCALE → HEAD : greffe ADDITIVE sur v143 de (1) 20 entrées JURY_DATA de l'enrichissement hebdomadaire produites en local et jamais déployées (JURY_DATA 49 → 69) et (2) 6 correctifs de signalements élèves appliqués en local depuis le 2026-06-22 : racines n-ièmes (exp reformulée en groupe U_n), det(AB) (ajout det(AB)=detA·detB=det(BA) même si AB≠BA), C_{V,m} gaz parfait monoatomique (accept élargi : 3/2R, 3R/2, 1.5R, 1,5R…), oscillateur harmonique (exp : x = écart à l'équilibre, second membre nul ; forme amortie), capacité d'une pile (F = constante de Faraday), système pseudo-isolé (1\textsuperscript{re} → « première », commande non rendue par MathJax). Énoncés q / qHash / ordre des 1551 cartes INCHANGÉS → SRS/FSRS-6 préservé ; schémas FIG (701) et explorateurs GeoGebra (19) intacts ; 0 artefact Cloudflare ; node --check OK.  /* ── v138 INDUCTION — RE-VÉRIFICATION CONFORMITÉ (la vérif du run initial v131 avait échoué). Workflow adversarial 12 agents (conformité programme 1.7-1.12 + rigueur physique) sur les 6 chapitres déployés. 13 corrections SRS-safe (q jamais touché) : coeff. de couplage k / M²≤L1L2 / 'théorème de réciprocité' marqués COMPLÉMENTS hors-programme TSI1 (circuit_fixe) ; nuance 'courant induit sans mouvement si champ inducteur variable' (induction_lois) ; ajout dF=I dl∧B (laplace) et point de vue motionnel e=∫(v×B)·dl (circuit_mobile) ; 'force toujours résistante'→'ici, générateur' ; Helmholtz recentré sur solénoïde ; hypothèse rotation lente ; notation ω pulsation vs vitesse ; défluxage=extension. Haut-parleur CONFIRMÉ hors-programme 1.12 (chapeau seulement). ── v137 MOT DU JURY — +11 ENTRÉES ADDITIVES (Centrale-Supélec TSI 2025 ×5, CCINP TSI 2020 ×3, CCINP TSI 2019 ×3) extraites des rapports officiels du jury (rédaction, hypothèses de théorèmes, erreurs types : gradient = vecteur des dérivées partielles, théorème du rang sur le nb de colonnes, inversibilité ⟺ 0 ∉ Sp, matrice orthogonale AᵀA=I, V(X+a)=V(X), sin 2π-périodique, majoration ≠ équivalence). Ajout dans JURY_DATA uniquement → QUESTIONS/énoncés/qHash/SRS/FSRS/physique-chimie/schémas/design INCHANGÉS ; 0 artefact Cloudflare ; node --check OK. ── v109 PHYSIQUE-CHIMIE TSI1 — RUBRIQUES EN CONFORMITÉ PROGRAMME OFFICIEL 2021 (greffé sur v108 « Nettoyage fiches PDF », INTACT) : 27 chapitres réalignés sur les 4 thèmes officiels. RETIRÉS de TSI1 : diagrammes potentiel-pH (→ TSI2), aspect corpusculaire de la lumière, classification périodique. AJOUTÉS : oscillateurs forcés (1.5), approche énergétique du mouvement (2.3), énergie échangée (3.2), relations structure–propriétés (4.2). Libellés recalés sur l'officiel. Rubriques VIDES (0 carte → 0 qHash, aucun impact SRS/FSRS). Suppression du système de fiches PDF/JPG (v108) et tout le contenu maths/FSRS/schémas/Mot du jury/design INCHANGÉS. node --check OK. ── v107 FONDU INTER-CARTES DÉTERMINISTE : le fondu d'apparition entre cartes ne dépend plus de la vitesse du typeset MathJax (avant : visible seulement si le typeset était lent → « pop » sec sur les QCM perso rapides, sensation de bug). Remplacé par une animation CSS cardFade (classe .card-in, fondu + léger glissé 4px sur .24s) REJOUÉE à chaque carte via le code partagé renderReveal → quiz perso ET flashcards ont désormais le même fondu fluide ; anti-flash du LaTeX brut conservé (élément masqué pendant le typeset, l'animation prend le relais au dévoilement). CSS-only + 6 lignes JS, additif, AUCUN impact SRS/FSRS. ── v106 FIX TIMING SRS (file de session, moteur FSRS inchangé) : (1) réinjection des paliers d'apprentissage resserrée de 20 min → 60 s (SRS_LEARN_COLLAPSE_MS) — une carte notée « Correct/10 min » n'enchaîne plus tout de suite : elle attend son palier et d'AUTRES cartes sont proposées entre-temps ; (2) l'ENTRAÎNEMENT LIBRE n'inclut plus jamais une carte planifiée dans le futur (due > maintenant) — une carte notée « Correct, +2 j » ne réapparaît plus le jour même et n'est plus re-planifiée en double (timing cassé corrigé). Conséquence : une session ILLIMITÉE (∞) se conclut par le bilan « à jour » quand tout le dû/nouveau/pratiquable est fait, au lieu de recycler le programme. Énoncés q / qHash / review() / _project() / poids FSRS INCHANGÉS → progression SRS préservée (8/8 cas de timing simulés OK, node --check OK). ── v105 FIX EXPLORATEUR 3D (mobile) : l'applet GeoGebra s'ouvre désormais dans une FENÊTRE MODALE plein écran (overlay .modal-overlay + bouton ✕, fermeture clic-dehors / Échap) au lieu d'être inline dans la carte. Corrige le « piège de défilement » mobile (l'applet 3D capturait le doigt pour tourner → impossible de scroller jusqu'aux boutons de note) + les soucis de taille ; l'applet est dimensionné à la fenêtre et DÉTRUIT à la fermeture (api.remove(), perf). Compatible plein écran .fs-active (modale ajoutée à #quizScreen comme le modal de signalement). Bouton « Explorer en 3D » réutilisable (plus masqué au clic). ── v104 SCHÉMAS 3D — PROJECTEURS / SYMÉTRIES : explorateur « Explorer en 3D » (GeoGebra) ajouté EN COMPLÉMENT du schéma 2D sur 5 cartes (projecteur ×2, symétrie, supplémentaires ×2 ; chapitres ev + applications_lineaires) — cas canonique R³ : projection sur un plan F parallèlement à une droite G (P=p(x) = point où la parallèle à G passant par x perce F ; décomposition x=p(x)+(x−p(x))), et symétrie oblique (Sx=2P−M). Additif (champ ggb, énoncés q INCHANGÉS → SRS préservé) ; le 2D reste affiché pour le concept, le 3D se charge au clic pour le cas spatial. 18 explorateurs GeoGebra + 52 figures FIG au total. ── v103 UX : retrait du champ « N° étudiant ou remarque » à l'inscription ET au profil (inputs authNote/pgNote + lectures JS retirés ; profil sans note) ; retrait du SWIPE mobile de notation (fonction setupGradeSwipe + indice « glisse pour noter ») qui faisait avancer la carte par glissement accidentel et buggait — la notation se fait désormais uniquement au TAP sur les boutons. Schémas (52 figures FIG + 13 explorateurs GeoGebra) et fonctions classes v102 INCHANGÉS. ── v102 CLASSES TSI0/1/2 + GESTION DES MEMBRES + SUPPRESSION ROBUSTE : à l'inscription l'élève CHOISIT sa classe (boutons TSI0/TSI1/TSI2 sur l'accueil ET dans le verrou d'accès) → écrit filiere=TSI + annee, regroupé automatiquement dans la console prof. Console admin : bouton « ✗ Retirer » + menu déroulant « changer de classe » sur CHAQUE membre approuvé (avant : aucune action possible une fois approuvé). Approbation / retrait / déplacement / réparation écrits en REPLI CLIENT direct (un compte enseignant a le droit d'écrire profile.classStatus/annee par les règles Firestore) si la Cloud Function setClassApproval est indisponible. SUPPRESSION DE COMPTE durcie : quand deleteAccount renvoie « internal » (fonction non déployée / plan Blaze), repli client qui efface les DONNÉES (doc users + sessions + pseudo, teacher-allowed) ; le login Firebase restant est clairement signalé (console Authentication / redéploiement). Cloud Function deleteAccount durcie séparément (message lisible au lieu d'« internal », fallback manuel si recursiveDelete indispo). Énoncés/SRS/FSRS-6/32 chapitres/schémas/design/Mot du jury INCHANGÉS. ── v101 GÉOMÉTRIE 3D (GeoGebra) : explorateurs 3D interactifs « Explorer en 3D » sur 13 cartes geoespace (produit vectoriel ⊥ plan + norme, produit mixte = volume du parallélépipède, plans parallèles ⟺ normales colinéaires, intersection de deux plans, vecteur normal au plan, sphère). Champ additif ggb:{obs,leg,cmds} → bouton + hôte ajoutés à exp au chargement (énoncés q INCHANGÉS → SRS préservé) ; applet GeoGebra 3D (vue 3D seule) chargé LAZY au clic depuis geogebra.org (en ligne) avec bandeau « À observer » + légende couleurs (thémés). Reste de la carte et app = légers/hors-ligne/thémés ; CSP déjà permissive. Page de test temporaire labo-3d.html. ── v100 ANNULATION (anti-miss-click) : bouton « ↶ Annuler » dans la barre du quiz + raccourci Ctrl/Cmd+Z. Un clic accidentel sur une note (Oubli/Difficile/Correct/Facile, confiance QCM, « Je ne sais pas ») fait avancer la carte ET corrompt la planification SRS — désormais réversible. Avant chaque notation, instantané MINIMAL (état SRS de la carte via qHash + daily/streak/reviewLog + compteurs de session score/streak/count) ; l'annulation restaure cet état et ré-affiche la carte vierge pour la re-noter. Multi-niveaux (pile bornée à 60), SRS-safe (énoncés q INCHANGÉS → hash préservés ; restauration chirurgicale validée par 26 tests sur le vrai moteur FSRS, dont oubli accidentel sur carte mûre restaurée à l'identique), mobile-safe (snapshot léger). En révision (file dynamique) l'annulation jette la carte piochée à la suite ; en quiz (pool fixe) le pool n'est pas tronqué. Ne vole pas l'annulation native pendant la saisie d'une réponse. ── v99 SCHÉMAS — PROBABILITÉS (+3 arbres pondérés composés avec segment+label, sans nouvelle primitive ; additif, SRS préservé ; 47 cartes à figure au total) : formule de Bayes, formule des probabilités totales (système complet), définition de la probabilité conditionnelle — arbre à 2 niveaux A/Ā puis B/B̄ avec probabilités sur les branches. Reste hors-FIG : géométrie 3D (~10 cartes) → décision GeoGebra parkée. ── v98 SCHÉMAS — LOT 3 (+16 figures FIG + nouvelle primitive `area` remplissage sous-courbe ; additif, SRS préservé ; 44 cartes à figure au total) : intégrale=aire (∫₀^π sin=2), croissance f≤g, ∫ fonction impaire=0 (aires +/− qui se compensent), Chasles (aire découpée en a<c<b), convexité/position courbe-tangente, équivalents en 0 (ln(1+x)∼x, 1−cos x∼x²/2, eˣ−1∼x, sin x∼x), suites adjacentes (intervalles emboîtés), domaine de ln, arccos (domaine/image), amplitude de a cos x+b sin x. ── v97 SCHÉMAS — LOT 2 (+21 figures FIG, additif, énoncés q INCHANGÉS → SRS préservé ; 28 cartes à figure au total) : cercle trigonométrique (cos π/6, sin π/3, tan π/4, cos π, identité cos²+sin²=1, arcsin), plan complexe (module |3+4i|, arg(−1), conjugué, e^{iπ}, e^{iπ/2}), racines n-ièmes (hexagone régulier), arctan (asymptotes ±π/2), croissance comparée ln≪x≪eˣ, valeur absolue |x|, parité, théorème de Rolle, accroissements finis (TAF), distance point-droite, vecteur normal. ── v96 GÉNÉRATEUR DE SCHÉMAS (FIG) : fonction FIG ajoutée (mini-DSL SVG inline — 1 SEUL repère pour formes ET labels, flèches/arcs générés, currentColor → 3 thèmes, labels rendus par MathJax) ; champ déclaratif fig:{window,items} converti en SVG dans exp AU CHARGEMENT (énoncés q INCHANGÉS → SRS préservé ; try/catch : une figure invalide ne casse jamais l'app). 7 cartes équipées : ln, Al-Kashi, tangente, TVI, suite récurrente (escalier/cobweb), produit scalaire (angle), somme de Riemann. Tâche « signalements-check-tsi » branchée : une demande de schéma fondée → ajout d'un champ fig (catalogue de figures-types) au lieu de « non fondé ». ── v94 FIX LABELS MATH (alpha/vec) : en v93, le re.sub de génération avait collapsé les doubles antislashs des labels en simple → après eval JS, la commande LaTeX (alpha, vec) perdait son antislash et s'affichait en toutes lettres (ex. « ialpha ») dans les schémas rotation et droite. Correctif : doublage des antislashs dans les régions figure → eval JS redonne la bonne commande → MathJax rend α et le vecteur. Cercle/monotone non touchés (labels sans commande). ── v93 SCHÉMAS — LABELS MATHJAX : les écritures des schémas sont désormais rendues par MathJax (le moteur mathématique de l'app), typographie STRICTEMENT identique au reste des cartes (vraies écritures mathématiques, fini le Computer Modern de TikZ jugé incohérent). Géométrie = SVG inline (currentColor → thèmes), labels = spans $...$ positionnés en % et typeset par MathJax. AUCUNE dépendance ajoutée (MathJax déjà chargé + en cache offline). Énoncés q inchangés (figure dans exp) → SRS préservé. ── v92 FIX THÈME NUIT : dans les schémas TikZ, les labels et points (glyphes sans attribut fill) héritaient du NOIR par défaut → invisibles sur fond sombre (thème Nuit). Correctif : fill='currentColor' ajouté sur la racine <svg> → labels + points adoptent la couleur d'encre du thème (vérifié sur fond Nuit : tout visible). ── v91 SCHÉMAS PRO (TikZ) : les 4 schémas refaits avec TikZ + dvisvgm (qualité publication : typographie LaTeX, flèches Stealth, géométrie précise) ; labels tracés en chemins (--no-fonts, autonomes), couleurs #000 → currentColor (compatibles thèmes). Remplacent les schémas tracés main de v90. Énoncés q inchangés (schéma dans exp) → SRS préservé. ── v90 SCHÉMAS : schémas SVG inline (currentColor, compatibles thèmes Papier/Nuit/Contraste) ajoutés dans le champ exp de 4 cartes (énoncés q inchangés → SRS préservé) — cercle |z-a|=r, rotation par e^{iα}, fonction monotone (limites latérales en un point intérieur), droite paramétrique M=A+t·u. ── v89 SIGNALEMENTS + CONFORMITÉ PROGRAMME : retrait du terme « sous-espace affine » (HORS-PROGRAMME TSI1, explicite au programme) de 6 cartes (systèmes ×2, équations différentielles/exp ×4 ; maths inchangées) ; « accept » de l'espérance E(X) élargi (formes commutées + notation p_i) ; enrichissements (définition des bases de la composée, « théorème des bornes atteintes / Weierstrass », récurrence sur Z, invariants de similitude). Énoncés (q) inchangés → SRS préservé. ── SRS — FSRS-6 : rétention cible IMPOSÉE à 92 % (curseur élève RETIRÉ). Décision : l'optimum d'ancrage est ~90 % (difficulté désirable + équilibre Anki), PAS plus haut ; on penche très légèrement vers la rétention (92 %, lean concours) sans l'excès contre-productif de 95 %+. Modifiable seulement via setFsrsRetention (console prof/admin), pour éviter qu'un élève sous-révise. ── v87 PASSAGE À FSRS-6 (algo avancé d'Anki, option recommandée — PAS le défaut SM-2 d'Anki) : le moteur de révision n'utilise plus SM-2 mais FSRS (mémoire Stabilité/Difficulté par carte ; intervalle = f(rétention cible)). Paliers d'apprentissage courts conservés (1m/10m) ; max interval 365 j (horizon prépa). Paliers d'apprentissage en minutes conservés ; migration DOUCE des cartes existantes (S amorcée depuis l'intervalle, D depuis l'ease, progression qHash préservée, dues inchangées jusqu'à la prochaine révision) ; port FIDÈLE de ts-fsrs validé numériquement (0 écart / 152 cas + 9 tests d'intégration). Poids FSRS-6 par défaut (optimisation perso possible plus tard via reviewLog déjà synchronisé). ── v86 SRS — MOTEUR DE PROGRESSION (6 correctifs) : #1 réinjection des paliers d'apprentissage EN session (dueLearning, collapse 20 min : les étapes 1/10 min vivent enfin) ; #2 détection LEECH (carte oubliée ≥8× signalée élève+prof) ; #3 oubli ADOUCI des cartes mûres (≥21 j → intervalle post-oubli plafonné à 7 j au lieu d'un reset à 1 j) ; #4 reviewLog SYNCHRONISÉ cloud (rétention vraie + heatmap multi-appareils) ; #5 LISSAGE du backlog (plafond 120 révisions/jour, « +N en attente ») ; #7 compteurs valides-only (plus d'orphelines dans globalStats). ── v85 RESTRUCTURATION CHAPITRES — les 20 chapitres maths regroupés deviennent les 32 chapitres NUMÉROTÉS de la prof (cahier de prépa tsi2-chaptal-paris) ; re-classement des 469 cartes selon la fiche rattachée à chacune (remap au chargement : seul le champ topic change, énoncés inchangés → progression SRS préservée) + 6 cartes « 15. TVI et bijections » créées (programme TSI1). ── v77 (conservé) PLEIN ÉCRAN + TRANSITIONS : zoom des cartes en plein écran agrandi (1.34em, énoncé 52px, choix 25px, colonne 1180px) + transition sans flash (typeset MathJax avant affichage + fondu .mj-pending + scrollQuizTop). ── v76 (conservé) ACCÈS CLASSE — fix « re-demande d'adhésion fantôme » : un élève DÉJÀ approuvé était renvoyé vers « Rejoindre la classe » (accueil + verrou révision) et sa re-demande était AVALÉE côté prof (la liste « en attente » filtrait via l'ancien roster). Corrigé : accueil/verrou respectent classStatus==='approved' (+ cache anti-aléa réseau) ; la console prof détecte les demandes via le doc de l'élève, plus le roster ; auto-réparation des membres de l'ancien roster sans classStatus. ── v75 (conservé) : le push v74 avait déployé une copie locale périmée (pré-v72) écrasant les raccourcis clavier + la fiche de cours en plein écran ; base v72 (GitHub HEAD f996b48a) restaurée + chapitre « Variables aléatoires » reconservé */const CORE = [
  './',
  './index.html',
  './manifest.json'
];
