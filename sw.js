...
const CACHE = 'quiz-tsi-v73';  /* re-déploiement (forçage publication GitHub Pages) — contenu identique à v72 : fiche de cours ouverte DANS le plein écran + raccourcis clavier 1-N/Entrée robustes */
const CORE = [
  './',
  './index.html',
  './manifest.json'
